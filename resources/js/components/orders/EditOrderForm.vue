...
<script>
    ...
    export default {
        ...
        props: ['code', 'countries', 'oldCountries', 'oldUniversities', 'oldSpecializations', 'oldBudget'],
        ...
        methods: {
            ...
            create(data) {
                axios.put(`/dashboard/orders/${this.code}`, data)
